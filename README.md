...
- [x] **Phase 13** — External connectors (Stripe billing + quotas, Slack deal-won, email provider + inbound parse, lead enrichment; Zapier via API+webhooks; Google/MS sync deferred)
```